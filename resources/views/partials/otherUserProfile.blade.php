...
<button type="button" class="btn btn-success btn-lg btn-block" id="btn_acceptFriend" data-sender-id="{{$user->id}}" data-receiver-id="{{Auth::user()->id}}">
    <i class="fas fa-check fa-fw"></i> Accept </button>
<button type="button" class="btn btn-outline-danger btn-lg btn-block" id="btn_declineFriend" data-sender-id="{{$user->id}}" data-receiver-id="{{Auth::user()->id}}">
