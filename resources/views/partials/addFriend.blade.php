    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3 class="text-center">
          ...
          <br>
          <button type="button" class="btn btn-success btn-lg btn-block" name="btn_acceptFriend" data-sender-id="{{$friend_request->sender->id}}" data-receiver-id="{{$friend_request->receiver->id}}">
            <i class="fas fa-check fa-fw"></i> Accept </button>
            <button type="button" class="btn btn-outline-danger btn-lg btn-block" name="btn_declineFriend" data-sender-id="{{$friend_request->sender->id}}" data-receiver-id="{{$friend_request->receiver->id}}">
