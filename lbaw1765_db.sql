...
ALTER TABLE ONLY eventInvite
    ADD CONSTRAINT eventInvite_owner_id_fk FOREIGN KEY (owner_id) REFERENCES owner(user_id) ON DELETE SET NULL;

ALTER TABLE ONLY eventInvite
    ADD CONSTRAINT eventInvite_receiver_id_fk FOREIGN KEY (receiver_id) REFERENCES user(id) ON DELETE SET NULL;

ALTER TABLE ONLY friendActivity
    ADD CONSTRAINT friendActivity_sender_id_fk FOREIGN KEY (sender_id) REFERENCES participant(user_id) ON DELETE SET NULL;
